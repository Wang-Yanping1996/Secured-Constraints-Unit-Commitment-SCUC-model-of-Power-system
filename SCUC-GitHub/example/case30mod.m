...
mpc.bus = [
	...
	11	1	3.2	1.7	0	0	1	1	0	135	1	1.05	0.95;
...
mpc.branch = [
	...
	27	28	0	0.4	0	65	65	65	0	0	1	-360	360;
  	27	28	0	0.4	0	65	65	65	0	0	1	-360	360;        %加了一条并联支路
...
%发电机系数调整
mpc.gencost(1,5) = 0.00375;
%发电机母线编号调整
% mpc.gen(:,1) = [1 2 5 8 11 13]';
% mpc.bus(:,2) = 1;
% mpc.bus(mpc.gen(:,1),2) = 2;
% mpc.bus(1,2) = 3;
%发电机有功出力上下限调整
mpc.gen(:,[9 10]) = [
     300 50;
...
%   (DT) (MW)
mpc.SCUC_data = [
     8  180  180 80  80   5         5         3           5       0          70      1e10;
     8  180  180 80  80   5         4         2           4       0          74      1e10;
     5  40  40 50  50   4         3         2           3       0          50       1e10;
     5  60  60 50  50   4         3         2           3       0          110     1e10;
     6  60  60 60  60   4         1         1           3       0          72      1e10;  
     3  40  40 60  60   2         4         2           4       0          40      1e10;
